...
//********************TITLE TWO***********************************************
 ...
 $pdf->Cell(0,-65,"Office Report For An Office Carried Out On $newDate ",0,0, "C");
//*********************END TITLE TWO******************************************
...
//******************TABLE BODY******************************************************
//fetch db values
 $stmt = $db->prepare('SELECT OfficeId, OfficeName, OfficeLocation FROM officestable WHERE DateAdded = :DateAdded');
