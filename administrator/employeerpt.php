...
//********************TITLE TWO***********************************************
 ...
 $pdf->Cell(0,-65,"Employee Report For An Employee Carried Out On $newDate ",0,0, "C");
//*********************END TITLE TWO******************************************
...
//******************TABLE BODY******************************************************
//fetch db values
 $stmt = $db->prepare('SELECT EmployeeNumber,EmployeeName,EmployeePhone,EmployeeEmail,EmployeeTown,Office,Department FROM new_technicianr WHERE DateAdded = :DateAdded');
