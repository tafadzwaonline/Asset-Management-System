														...
														<form class="form-horizontal" id="licences-form" method="get">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="AssetName" id="AssetName" class="col-xs-12 col-sm-6"  disabled="true" value="<?php echo $row2['AssetName']; ?>"/>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="SerialNumber" id="SerialNumber" class="col-xs-12 col-sm-6" disabled="true" value = "<?php echo strtoupper($row2['SerialNumber']); ?>"/>
																	</div>
																</div>
															</div>
                              <div class="form-group">
															...
															<div class="form-group" >
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="ActivationCode" id="ActivationCode" class="col-xs-12 col-sm-6" disabled />
																	</div>
																</div>
															</div>
															<div class="form-group">
		...
		function getData(LicenceId, divid){
			...
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
				  $.post('../custom/assignLicence.php',
				  {
				    SerialNumber: $('[name=SerialNumber]').val(),  ActivationCode:  $('[name=ActivationCode]').val(),
						AvailableSlots:  $('[name=AvailableSlots]').val(), LicenceName: $('[name=LicenceName]').val()
				  },
				  function(data){
						bootbox.dialog({
							message: data,
