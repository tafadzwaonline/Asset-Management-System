														...
														<form class="form-horizontal" id="validation-form" method="get">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="VendorNumber" name="VendorNumber" class="col-xs-12 col-sm-5" value="WPC/ICT/VENDOR/<?php echo $user->getLastRecord('new_vendor'); ?>" disabled/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="VendorName" name="VendorName" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="Town" name="Town" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/addVendor.php',
					{
						VendorNumber: $('[name=VendorNumber]').val(), VendorName: $('[name=VendorName]').val(), VendorPhone: $('[name=phone]').val(), VendorEmail: $('[name=email]').val(), VendorTown: $('[name=Town]').val()
				  },
					function(data){
						bootbox.dialog({
							message: data,
