<?php
	...
	$pagetitle ="My Assigned Items";
	$activeAssets = "active open";
	$activeReqItems= "active";
 ?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Requested asset</li>
						</ul><!-- /.breadcrumb -->
												...
												<div>
													<ul class="steps">
														...
														<li data-step="3">
															...
															<span class="title">Requisition Information</span>
														</li>
												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="general-information" method="get">
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="User">User:</label>

																<div class="col-xs-12 col-sm-9">
																	<select id="User" name="User" class="select2" data-placeholder="Click to Choose..."  onchange="getData(this.value)" >
																		<option value="">&nbsp;</option>
																		<<?php
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="UserOffice" id="UserOffice" class="col-xs-12 col-sm-4" disabled/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="UserDepartment" id="UserDepartment" class="col-xs-12 col-sm-4" disabled />
																	</div>
																</div>
															</div>
													...
													<div class="step-pane" data-step="2">
														...
														<form class="form-horizontal" id="asset-information" method="get">
															<div class="hr hr-dotted"></div>
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="SelectedAsset">Available Assets:</label>

																<div class="col-xs-12 col-sm-9">
																	<select id="SelectedAsset" name="SelectedAsset" class="select2" data-placeholder="Click to Choose..." onchange="getData(this.value)">
																		<option value="">&nbsp;</option>
																		<?php
																			$stmt = $db->query("SELECT * FROM new_item
																													WHERE NOT EXISTS(SELECT * FROM assigneditems WHERE new_item.SerialNumber = assigneditems.SerialNumber)");
																			while($row_status = $stmt->fetch())
																			{
																				?>
																					<option value="<?php echo $row_status['Id']; ?>" > <?php echo $row_status['AssetName'];?></option>
																				<?php
																			}
																		 ?>
																	</select>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetSerial" id="assetSerial" class="col-xs-12 col-sm-4" disabled=""/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetNumber" id="assetNumber" class="col-xs-12 col-sm-4" disabled="" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetName" id="assetName" class="col-xs-12 col-sm-4" disabled="" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetStatus" id="assetStatus" class="col-xs-12 col-sm-4" disabled=""/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetCondition" id="assetCondition" class="col-xs-12 col-sm-4" disabled=""/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-lg-3 col-md-4 col-sm-4">
																	<div class="input-group input-group-sm">
																		<input name ="warrantyExpiry" type="text" id="datepicker" class="form-control" disabled="" />
													...
													<div class="step-pane" data-step="3">
														...
														<form class="form-horizontal" id="finance-information" method="get">
															...
															<div class="space-2"></div>
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="AssignmentPeriod">Lending Period:</label>
																<div class="col-xs-12 col-sm-9">
													...
													<div class="step-pane" data-step="4">
														<div class="center">
															...
															Your asset information was entered succesfully! Click finish to save your requisition information!
														</div>
													</div>
												</div>
											</div>
...
<![endif]-->
		...
		function getData(AssetId){
				$.ajax({
						url: '../custom/getAssetCondition.php?AssetId='+AssetId, //call storeemdata.php to store form data
						success: function(html) {
								$('[name=assetCondition]').val(html);
						}
				});
				$.ajax({
						url: '../custom/getAssetName.php?AssetId='+AssetId, //call storeemdata.php to store form data
						success: function(html) {
								$('[name=assetName]').val(html);
						}
				});
				$.ajax({
						url: '../custom/getAssetStatus.php?AssetId='+AssetId, //call storeemdata.php to store form data
						success: function(html) {
								$('[name=assetStatus]').val(html);
						}
				});
				$.ajax({
						url: '../custom/getAssetSerial.php?AssetId='+AssetId, //call storeemdata.php to store form data
						success: function(html) {
								$('[name=assetSerial]').val(html);
						}
				});
				$.ajax({
						url: '../custom/getAssetNumber.php?AssetId='+AssetId, //call storeemdata.php to store form data
						success: function(html) {
								$('[name=assetNumber]').val(html);
						}
				});
				$.ajax({
						url: '../custom/getAssetWarranty.php?AssetId='+AssetId, //call storeemdata.php to store form data
						success: function(html) {
								$('[name=warrantyExpiry]').val(html);
						}
				});
		}
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/requestAsset.php',
				  {
				    assetSerial:  $('[name=assetSerial]').val(), assetNumber:  $('[name=assetNumber]').val(),
						AssignmentPeriod:  $('[name=AssignmentPeriod]').val(), NumberOfDays:  $('[name=NumberOfDays]').val()
				  },
				  function(data){
						bootbox.dialog({
							message: data,
				...
				*/
				...
				$('#general-information').validate({
					...
					messages: {
						...
						userDepartment: "Please specify the asset's model"
					},
				...
				$('#asset-information').validate({
					...
					messages: {
						...
						SelectedAsset: "You must select an asset first"
					},
