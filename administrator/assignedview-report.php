...
//********************INVENTORY TITLE*************************************
 ...
 $pdf->Cell(0,85,"Assigned Assets Report",0,0, "C");
 //******************END TITLE************************************************
...
// Headers and widths
 ...
 $header = array("SerialNumber","AssignedUser","OfficeName","DepartmentName");
 $w = array(38,38,38,38,32,35,35,38);
 $pdf->SetX(10);
...
");
 ...
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {
    ...
    $data[] = array($SerialNumber, $AssignedUser, $OfficeName,$DepartmentName);
