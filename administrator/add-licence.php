				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Add Licence</li>
						</ul><!-- /.breadcrumb -->
														...
														<form class="form-horizontal" id="licences-form" method="get">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="LicenceName" id="LicenceName" class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
                              <div class="form-group">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="ActivationCode" id="ActivationCode" class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" class="input-sm" id="LicenceSlots" name="LicenceSlots" />
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" class="input-sm" id="LicenceValidity"  name="LicenceValidity"/>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div>
																		<label class="line-height-1 blue">
																			<input name="reusable" value="1" type="radio" class="ace" />
																	...
																	<div>
																		<label class="line-height-1 blue">
																			<input name="reusable" value="2" type="radio" class="ace" />
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="url">Download URL:</label>
											...
											<div class="wizard-actions center">
												...
												<button class="btn btn-white btn-warning btn-bold" id="delete-dialog">
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/addLicence.php',
				  {
				    LicenceName: $('[name=LicenceName]').val(), LicenceVendor: $('[name=LicenceVendor]').val(),
						 ActivationCode:  $('[name=ActivationCode]').val(), LicenceSlots:  $('[name=LicenceSlots]').val(),
						  LicenceValidity:  $('[name=LicenceValidity]').val(), reusable:  $('input[name=reusable]:checked').val(),
							url:  $('[name=url]').val()
				  },
				  function(data){
						bootbox.dialog({
				...
				$('#licences-form').validate({
				    ...
				    LicenceVendor: "Please choose the licence vendor"
					},
