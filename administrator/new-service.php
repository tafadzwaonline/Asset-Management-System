																	...
																	<div class="tab-content">
																		...
																		<div id="repair" class="tab-pane fade">
																			...
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<textarea class="input-xlarge" name="RepairDerscription" id="RepairDerscription"></textarea>
																					</div>
																				</div>
																			</div>
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<select id="RepairedBy" name="RepairedBy" class="select2" data-placeholder="Click to Choose...">
																						<option value="">&nbsp;</option>
																						<!-- <<?php
																							//$stmt = $db->query('SELECT TechnicianName FROM new_technicianr ORDER BY TechnicianName DESC');
																							while($row = $stmt->fetch())
																							{
																								?>
																								<option> <?php echo $row['TechnicianName'];?></option>
																								<?php
																							}
																						 ?> -->
																					</select>
																			...
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-lg-3 col-md-4 col-sm-4">
																					<div class="input-group input-group-sm">
																						<input name ="RepairDate" type="text" id="RepairDate" class="form-control" />
																			...
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="RepairCost" id="RepairCost" class="col-xs-12 col-sm-4" />
																					</div>
																				</div>
			...
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/addservice.php',
					{
						...
						RepairDate: $('[name=RepairDate]').val(), Id: "<?php echo $_GET['id'];?>"
				  },
					function(data){
						bootbox.dialog({
							message: data,
