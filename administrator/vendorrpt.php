...
//********************TITLE TWO***********************************************
 ...
 $pdf->Cell(0,-65,"Vendors Report For An Inventory Carried Out On $newDate ",0,0, "C");
//*********************END TITLE TWO******************************************
...
// Headers and widths
 ...
 $header = array("VendorNumber","VendorName","VendorPhone","VedorEmail", "VendorTown");
...
//******************TABLE BODY******************************************************
//fetch db values
 $stmt = $db->prepare('SELECT VendorNumber, VendorName, VendorPhone, VendorEmail, VendorTown FROM new_vendor WHERE DateAdded = :DateAdded');
