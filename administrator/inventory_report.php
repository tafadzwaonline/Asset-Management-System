													...
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="office-form" method="get">
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="Inventory_Date">Inventory Date:</label>

																<div class="col-xs-12 col-sm-9">
																	<select id="Inventory_Date" name="Inventory_Date" class="select2" data-placeholder="Click to Choose a Date">
																		<option value="">&nbsp;</option>
																		<?php
																		  ...
																		  $stmt = $db->prepare($query);
																			...
																			?>
																				<option value="">  </option>
																				<option value="<?php echo $row['DateAdded'];?>"> <?php echo $row['DateAdded'];?> </option>
																			<?php
																			}
																			 ?>
																	</select>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					///call fpdf here son
					var date = $('[name=Inventory_Date]').val();

			    var url = $(this).attr('href');
			    window.open('inventoryrpt.php?date='+date, '_blank');
				...
				$('#office-form').validate({
				    ...
				    Inventory_Date: "Please select an Inventory Date to generate the report"
					},
