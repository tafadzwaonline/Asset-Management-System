														...
														<form class="form-horizontal" id="assignment-form" method="get">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="AssetName" id="AssetName" class="col-xs-12 col-sm-6" disabled = "" value="<?php echo $row2['AssetName']; ?>"/>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="SerialNumber" id="SerialNumber" class="col-xs-12 col-sm-6" disabled = "" value = "<?php echo strtoupper($row2['SerialNumber']); ?>"/>
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="AssetNumber" id="AssetNumber" class="col-xs-12 col-sm-6" disabled = "" value = "<?php echo strtoupper($row2['AssetNumber']); ?>"/>
																	</div>
																</div>
															</div>
                              <div class="form-group">
