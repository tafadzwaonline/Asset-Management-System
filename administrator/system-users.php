												...
												while($row=$stmt->fetch(PDO::FETCH_ASSOC))
												{
												 ...
												 ?>
													<tr>
														...
														<!-- <td><?php echo $user->countTotalAssetsByUser($row['Id']) ?></td> -->
														...
														<td>
															<div class="hidden-md hidden-lg">
 															 <div class="inline pos-rel">
 																 ...
 																 <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
 																	 <li>
																		 <a href="set-previledge?id=<?php $key = base64_encode($row['Id']); echo $key; ?>" class="tooltip-info" data-rel="tooltip" title="Previledge">
 																			 <span class="blue">
															...
															<div class="hidden-sm hidden-xs btn-group">
																<a href="set-previledge?id=<?php $key = base64_encode($row['Id']); echo $key; ?>" class="btn btn-xs btn-info" title="Previledge">
																	<i class="ace-icon fa fa-users bigger-120"></i>
																</a>
