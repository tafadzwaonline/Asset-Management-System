  ...
  <?php include('includes/header.php');?>
			<div class="main-content">
              ...
              <li>
							...
							<li class="active">Expired Licences</li>
						</ul><!-- /.breadcrumb -->
					...
					<?php include('includes/nav-setings.php');?>
                        ...
                        $form = date('Y-m-d', strtotime($date));
												...
												$stmt = $db->prepare("select `assetlicences`.`LicenceName`,
                                                     `assetlicences`.`AssetID`,
                                                     `assetlicences`.`LicenceID`,
                                                     `assetlicences`.`DateInstalled`,
                                                     `new_licence`.`Period`,
                                                     `new_licence`.`ReUsable`,
                                                     `assigneditems`.`OfficeName`,
                                                     `assigneditems`.`AssignedUser`,
                                                     DATEDIFF( '$form',`assetlicences`.`DateInstalled`) as DaysAgo
                            ...
                            <td><?php echo $user->getUserName($row['AssignedUser']); ?></td>
														<td>
                              <span class="label label-danger arrowed-right arrowed-in">
                                Expired <?php echo ($row['DaysAgo'] - $row['Period']);?> day(s) ago
                              </span>
														</td>
													</tr>
													<?php
