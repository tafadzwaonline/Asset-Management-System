				...
				<div class="main-content-inner">
					...
					<?php include('includes/nav-setings.php');?>
                        ...
                        $id = $_GET['id'];
                                       ...
                                       where
                                             (`assetlicences`.`LicenceID` = :LicenceID)
                                      ");
