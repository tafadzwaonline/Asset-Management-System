														...
														<form class="form-horizontal" id="office-form" method="get">
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="DepartmentId" id="DepartmentId" class="col-xs-12 col-sm-6" value="WPC/ICT/DEPT/<?php echo $user->getLastRecord('officedepartments'); ?>" disabled />
																	</div>
																</div>
															</div>
                              								<div class="form-group">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="DepartmentName" id="DepartmentName" class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					$.post('../custom/addDepartment.php',
				  {
				    DepartmentId: $('[name=DepartmentId]').val(), ParentOffice: $('[name=ParentOffice]').val(), DepartmentName:  $('[name=DepartmentName]').val()
				  },
				  function(data){
						bootbox.dialog({
							message: data,
