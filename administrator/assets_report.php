<?php
	...
	$pagetitle ="Assets Report";
	$activeReport = "active open";
	$activeAsset_Report= "active";
		...
		<script type="text/javascript">
			jQuery(function($) {
			    ...
			    var url = $(this).attr('href');
					...
					// window.open('assetview-report.php?date='+date1, '_blank');

				window.open('assetsview-report.php?date1='+date1+'&date2='+date2, '_blank');
					// window.open('assetrpt.php?date='+date, '_blank');
