															...
															<div class="row">
																<div class="tabbable">
																	<ul class="nav nav-tabs" id="myTab">
																		...
																		<li>
																			<a data-toggle="tab" href="#custodian">
																	...
																	<div class="tab-content">
																		<div id="home" class="tab-pane fade in active">
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="SerialNumber" id="SerialNumber" class="col-xs-12 col-sm-6" value="<?php echo $row['SerialNumber']; ?>" disabled />
																					</div>
																				</div>
																			</div>
																			...
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="SerialNumber" id="SerialNumber" class="col-xs-12 col-sm-6" value="<?php echo $row['Type']; ?>" disabled />
																					</div>
																				</div>
																			</div>
																			...
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="AssetNumber" id="AssetNumber" class="col-xs-12 col-sm-6"  value="<?php echo $row['Model']; ?>" disabled/>
																					</div>
																				</div>
																			</div>
																			<!-- <div class="form-group">
																			...
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="AssetNumber" id="AssetNumber" class="col-xs-12 col-sm-6"  value="<?php echo $row['AssetCondition']; ?>" disabled />
																					</div>
																				</div>
																			</div>
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ScrapValue" id="ScrapValue" class="col-xs-12 col-sm-6" value="<?php echo $row['Status']; ?>" disabled />
																					</div>
																				</div>
																			</div>
																			<!-- <div class="form-group">
																		...
																		<div id="finance" class="tab-pane fade">
																			<div class="form-group">
																				<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="PurchasePrice">Purchase Price:</label>

																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="PurchasePrice" id="PurchasePrice" class="col-xs-12 col-sm-6" value="<?php echo $row['PurchasePrice']; ?>" disabled />
																					</div>
																				</div>
																			</div>
																			<div class="form-group">
																				<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="ScrapValue">Depreciation Rate (%):</label>

																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ScrapValue" id="ScrapValue" class="col-xs-12 col-sm-6" value="<?php echo str_replace(',00', '',number_format($row['ScrapValue'], 2, ',', '')) ; ?>" disabled />
																					</div>
																				</div>
																			</div>
																			<div class="form-group">
																				<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="ExpectedLife">Expected life(Years):</label>

																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ExpectedLife" id="ExpectedLife" class="col-xs-12 col-sm-6" value="<?php echo str_replace(',00', '', number_format($row['ExpectedAssetLife'], 2, ',', '')) ; ?>" disabled />
																					</div>
																				</div>
																			</div>
																...
																<div class="col-xs-12 col-lg-3 col-md-4 col-sm-4">
																	<div class="clearfix">
																		<input name ="purchaseDate" type="text" id="datepicker2" class="col-xs-12 col-sm-6" value="<?php echo $row['PurchaseDate']; ?>" disabled />
															 ...
															 <div class="hr hr-dotted"></div>
																			...
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<select id="DepreciationMethod" name="state" class="select2" data-placeholder="Click to Choose..." onchange="getData(this.value, 'displaydata')">
																						<option value=" "></option>
																						 <option value="1">Full Year Depreciation</option>
																						<option value="2">Monthly Depreciation</option>
																		...
																		<div id="custodian" class="tab-pane fade">
																			<div class="form-group">
																				...
																				<div class="col-xs-12 col-sm-9">
																					<div class="clearfix">
																						<input type="text" name="ScrapValue" id="ScrapValue" class="col-xs-12 col-sm-6" value="<?php if($row['SerialNumber']=="N/A"){echo $user->getAssignedUserName($user->getCustodian($row['AssetNumber']));}else{echo $user->getAssignedUserName($user->getCustodian($row['SerialNumber']));}  ?>" disabled />
																					</div>
																				</div>
																			</div>
																		</div>
