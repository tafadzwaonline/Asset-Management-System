<?php
	...
	$pagetitle ="Office Report";
	$activeReport = "active open";
	$activeOffice_Report= "active";
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Office Reports</li>
						</ul><!-- /.breadcrumb -->
		...
		<script type="text/javascript">
			jQuery(function($) {
			    ...
			    var url = $(this).attr('href');
					...
					// window.open('officeview-report.php?date='+date1, '_blank');

				window.open('officeview-report.php?date1='+date1+'&date2='+date2, '_blank');
					// window.open('Officerpt.php?date='+date, '_blank');
