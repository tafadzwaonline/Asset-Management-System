<?php
	...
	$activeDepartment_Report= "active";
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Department Reports</li>
						</ul><!-- /.breadcrumb -->
		...
		<script type="text/javascript">
			jQuery(function($) {
			    ...
			    var url = $(this).attr('href');
					...
					// window.open('dptview-report.php?date='+date1, '_blank');

				window.open('dptview-report.php?date1='+date1+'&date2='+date2, '_blank');
