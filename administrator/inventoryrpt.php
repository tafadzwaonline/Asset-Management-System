...
//********************INVENTORY TITLE*************************************
 ...
 $pdf->Cell(0,85,"Single Day Inventory Reports",0,0, "C");
 //******************END TITLE************************************************

//********************TITLE TWO***********************************************
 $pdf->Ln();
 $pdf->SetFont('Arial','B',16);
 $pdf->Cell(0,-65,"Inventory Report For An Inventory Carried Out On $newDate ",0,0, "C");
//*********************END TITLE TWO******************************************
...
//******************TABLE BODY******************************************************
//fetch db values
 $stmt = $db->prepare('SELECT Id, AssetNumber, AssetSerial, Status, AssetCondition, Custodian, Office, Department FROM new_inventory WHERE DateAdded = :DateAdded');
