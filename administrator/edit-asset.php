												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="general-information" method="get">
																...
																<div class="col-xs-12 col-sm-9">
																	<select id="assetType" name="assetType" class="select2" data-placeholder="Click to Choose...">
																		...
																		<<?php
																			...
																			{
																				?>
																				<option value="<?php echo $row_category['CategoryName']; ?>" <?php if($row_category['CategoryName']==$row['Type']){echo "selected = 'true'";} ?>> <?php echo $row_category['CategoryName'];?></option>
																				<?php
																			}
																		 ?>
																	</select>
															...
															<!-- <div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetManufacturer" id="assetManufacturer" class="col-xs-12 col-sm-4" value="<?php echo $row['Manufacturer']; ?>" />
																	</div>
																</div>
															</div> -->
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetModel" id="assetModel" class="col-xs-12 col-sm-4"  value="<?php echo $row['Model']; ?>"/>
																	</div>
																</div>
															</div>
													...
													<div class="step-pane" data-step="2">
														...
														<form class="form-horizontal" id="asset-information" method="get">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetSerial" id="assetSerial" class="col-xs-12 col-sm-4" value="<?php echo $row['SerialNumber']; ?>" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetNumber" id="assetNumber" class="col-xs-12 col-sm-4" value="<?php echo $row['AssetNumber']; ?>" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetName" id="assetName" class="col-xs-12 col-sm-4" value="<?php echo $row['AssetName']; ?>"/>
																	</div>
																</div>
															</div>
																...
																<div class="col-xs-12 col-sm-9">
																	<select id="assetStatus" name="assetStatus" class="select2" data-placeholder="Click to Choose...">
																		...
																		<?php
																			...
																			{
																				?>
																					<option value="<?php echo $row_status['Status']; ?>" <?php if($row_status['Status']==$row['Status']){echo "selected = 'true'";} ?>> <?php echo $row_status['Status'];?></option>
																				<?php
																			}
																		 ?>
																	</select>
																...
																<div class="col-xs-12 col-sm-9">
																	<select id="assetCondition" name="assetCondition" class="select2" data-placeholder="Click to Choose...">
																		...
																		<?php
																			...
																			{
																				?>
																					<option value="<?php echo $row_Condition['AssetCondition']; ?>" <?php if($row_Condition['AssetCondition']==$row['AssetCondition']){echo "selected = 'true'";} ?>> <?php echo $row_Condition['AssetCondition'];?></option>
																				<?php
																			}
																		 ?>
																	</select>
															...
															<!-- <div class="form-group">
																...
																<div class="col-xs-12 col-lg-3 col-md-4 col-sm-4">
																	<div class="input-group input-group-sm">
																		<input name ="warrantyExpiry" type="text" id="datepicker" class="form-control" value="<?php echo $row['WarrantyExpiry']; ?>" />
													...
													<div class="step-pane" data-step="3">
														...
														<form class="form-horizontal" id="finance-information" method="get">
																...
																<!-- <div class="col-xs-12 col-sm-9">
																	<select id="assetVendor" name="assetVendor" class="select2" data-placeholder="Click to Choose...">
																		...
																		<<?php
																			...
																			{
																				?>
																					<option value="<?php echo $row_vendor['VendorName']; ?>" <?php if($row_vendor['VendorName']==$row['Vendor']){echo "selected = 'true'";} ?>> <?php echo $row_vendor['VendorName'];?></option>
																				<?php
																			}
																		 ?>
																	</select>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetPurchasePrice" id="assetPurchasePrice" class="col-xs-12 col-sm-4" value="<?php echo $row['PurchasePrice']; ?>" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="ExpectedAssetLife" id="ExpectedAssetLife" class="col-xs-12 col-sm-4" value="<?php echo $row['ExpectedAssetLife']; ?>"/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="assetScrapValue" id="assetScrapValue" class="col-xs-12 col-sm-4" value="<?php echo $row['ScrapValue']; ?>" />
																	</div>
																</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-lg-3 col-md-4 col-sm-4">
																	<div class="input-group input-group-sm">
																		<input name ="purchaseDate" type="text" id="datepicker2" class="form-control" value="<?php echo $row['PurchaseDate']; ?>" />
													...
													<div class="step-pane" data-step="4">
														<div class="center">
															...
															Your asset information was entered succesfully! Click finish to save your data!
														</div>
													</div>
												</div>
											</div>
