...
//if user exists..
    if($_SESSION['Role']!="1"){
      ...
      $stmt2 = $db->prepare("SELECT Id, Email FROM profilemaster WHERE Role <> 5");
      $stmt2->execute();
        ...
        $message = '<!doctype html>';
         ...
         $message.='font-weight: normal; padding-left: 36px; padding-right: 36px;" valign="top" align="left">';
           ...
           $message.='width: 378px;" valign="top" align="left">';
            ...
            $message.='padding-bottom: 10px; padding-top: 15px;" valign="top" align="left"></td></tr></tbody></table>';
             $message.='<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">';
               $message.='<b style="color: #777777;"> '.$MyName.' says: </b>';
               $message.='<br>';
               $message.=''.$msg.'';
             $message.='</div>';
         ...
         $message.='font-weight: normal; padding-left: 36px; padding-right: 36px;" valign="top" align="left">';
           ...
           $message.='width: 378px;" valign="top" align="left">';
             $message.='<div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">';
               $message.='<a href = "http://'.$server.'" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">&nbsp; Login here to reply &nbsp;</a>';
             $message.='</div>';
